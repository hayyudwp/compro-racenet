            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <h5 class="card-title">Form Edit Header</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="desc" rows="5" required>{{ $header->desc }}</textarea>
                                    </div>
                                </div>
                            </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="{{ asset('storage/header') }}/{{$header->image}}" width="100%">
            </div>
        </div>
    </div>
</div>
