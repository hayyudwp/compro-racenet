    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">New Colocation Server Detail</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <h5 class="card-title">Form New Colocation Server Detail</h5>

                        <!-- General Form Elements -->
                        <form action="{{ route('colocation-detail.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="category" class="form-control" value="colocation" hidden>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
