    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">New About Content</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <h5 class="card-title">Form New About Content</h5>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="desc" id="editor1" rows="5" required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="row">
