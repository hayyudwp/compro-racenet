...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">Broadband Internet</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <h5 class="card-title">List Broadband Internet</h5>
                            <div class="py-3">
                                <a href="{{ route('broadband.create') }}" class="btn btn-primary">
