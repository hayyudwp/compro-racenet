                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <h5 class="card-title">List Home Content</h5>
                            <div class="py-3">
                                <a href="{{ route('homecontent.create') }}" class="btn btn-primary">
                                    <i class="bi bi-plus-circle me-1"></i> New Home Content
                                </a>
                            </div>
                        </div>
